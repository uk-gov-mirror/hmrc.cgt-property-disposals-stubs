...
|     -       | `...5910` | `5810...` | hard coded trust BPR                                                   |   approved with conditions                           | -                                             |            
| `SB11...`   | `...5911` |     -     | hard coded individual BPR                                              |   revoked                                            | -                                             |            
|     -       | `...5911` | `5811...` | hard coded trust BPR                                                   |   revoked                                            | -                                             |            
| `SB12...`   | `...5912` |     -     | hard coded individual BPR                                              |   deregistered                                       | -                                             |            
|     -       | `...5912` | `5812...` | hard coded trust BPR                                                   |   deregistered                                       | -                                             |            
| `SB13...`   | `...5913` |     -     | hard coded individual BPR                                              |   contract object inactive                           | -                                             |            
|     -       | `...5913` | `5813...` | hard coded trust BPR                                                   |   contract object inactive                           | -                                             |            
| `SB14...`   | `...5914` |     -     | hard coded individual BPR                                              |   400 (Bad Request) response (INVALID_REGIME)        | -                                             |            
|     -       | `...5914` | `5814...` | hard coded trust BPR                                                   |   400 (Bad Request) response (INVALID_REGIME)        | -                                             |            
| `SB15...`   | `...5915` |     -     | hard coded individual BPR                                              |  400 (Bad Request) response (INVALID_BPNUMBER)      | -                                             |            
|     -       | `...5915` | `5815...` | hard coded trust BPR                                                   |  400 (Bad Request) response (INVALID_BPNUMBER)      | -                                             |            
| `SB16...`   | `...5916` |     -     | hard coded individual BPR                                              |  400 (Bad Request) response (INVALID_CORRELATIONID) | -                                             |            
|     -       | `...5916` | `5816...` | hard coded trust BPR                                                   |  400 (Bad Request) response (INVALID_CORRELATIONID) | -                                             |            
| `SB17...`   | `...5917` |     -     | hard coded individual BPR                                              |  404 (Not Found) response                           | -                                             |            
|     -       | `...5917` | `5817...` | hard coded trust BPR                                                   |  404 (Not Found) response                           | -                                             |            
| `SB18...`   | `...5918` |     -     | hard coded individual BPR                                              |  500 (Internal Server Error) response               | -                                             |            
|     -       | `...5918` | `5818...` | hard coded trust BPR                                                   |  500 (Internal Server Error) response               | -                                             |            
| `SB19...`   | `...5919` |     -     | hard coded individual BPR                                              |  503 (Service Unavailable) response                 | -                                             |            
|     -       | `...5919` | `5819...` | hard coded trust BPR                                                   |  503 (Service Unavailable) response                 | -                                             |            
